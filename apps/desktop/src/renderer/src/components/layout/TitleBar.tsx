...
export function TitleBar() {
  return (
    <header className="flex h-9 items-center justify-between border-b bg-card px-3 select-none [-webkit-app-region:drag]">
      <span className="text-xs font-semibold tracking-wide text-muted-foreground">OrcaSlicerNeo</span>
      {/* no-drag: the window is frameless, buttons must stay clickable */}
