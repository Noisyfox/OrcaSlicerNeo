...
to objects, split to parts, separate instances, assemble all) were removed from
the row chrome and moved into a per-row right-click context menu, mirroring the
scene context menu.
