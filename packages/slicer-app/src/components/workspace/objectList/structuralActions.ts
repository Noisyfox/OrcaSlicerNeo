...
type StructuralMutation = { ok: boolean; error?: string; plateSession?: PlateSessionMutation };

async function runStructuralHistory(
  runtime: SlicerRuntime,
  label: string,
  mutation: () => Promise<StructuralMutation>,
