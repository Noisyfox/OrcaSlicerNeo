  ...
  return (
    <ContextMenuPrimitive.Trigger
      ...
      onContextMenuCapture={(event) => {
        onContextMenuCapture?.(event);
        // A ContextMenu trigger may wrap inline editors. Keep the native
        // browser/Electron copy-paste menu for those controls instead of
        // allowing the trigger's right-click handler to consume the gesture.
