...
// Official base-mira anatomy minus the Textarea variant (the app has no
// textarea component). The `in-data-[slot=combobox-content]` classes keep the
// group's border/focus ring from fighting the popup's restyled input-group.
