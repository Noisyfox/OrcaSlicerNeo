...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      ...
      className={cn(
        "flex items-center rounded-[calc(var(--radius-md)-2px)] px-2 py-[calc(--spacing(0.85))] text-xs/relaxed font-medium outline-hidden select-none hover:bg-accent aria-expanded:bg-accent",
        className
      )}
      {...props}
    />
